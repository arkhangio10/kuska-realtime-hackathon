# Guion de demo (85 segundos)

## Preparación antes de grabar

- Abrir la demo pública en una ventana normal y otra de incógnito.
- Hacer una recarga completa en ambas ventanas y elegir exactamente el mismo caso.
- Confirmar que producción esté registrada en **Portal → Allowed Origins**.
- Mantener visible el cronómetro y terminar antes de 1 minuto y 30 segundos.

## Narración y acciones

1. **0–10 s — Elegir una misión real.** Girar el planeta, señalar que los marcadores proceden de GDACS e IFRC GO y abrir un caso activo o reciente.
...
Portal hace compartida la misión: sincroniza personas, avatares, conversación, alternativas y votos. La IA facilita y representa; la comunidad decide.
